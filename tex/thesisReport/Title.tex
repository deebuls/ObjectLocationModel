...
\vspace{0.15in}
\begin{small}
\emph{Matriculation Nr.}: \MatID %\href{\PaperMainWriterEMail}{\PaperMainWriter \footnote{\href{\PaperMainWriterEMail} {santosh.thoduka@smail.inf.fh-bonn-rhein-sieg.de}}}
 \par
\end{small}
